    ...
    create or replace table `ps-silver-gold`.`silver_google_ads_dev`.`google_ads__gender_report`
...
fields AS (
    ...
    FROM
        ...
        AND stats.segments_date = ad_groups._DATA_DATE
        LEFT JOIN campaigns
        ON ad_groups.campaign_id = campaigns.campaign_id
        AND stats.segments_date = campaigns._DATA_DATE
        LEFT JOIN accounts
